...
Public Class FormHelpers
    ...
    Public Shared Sub dumpException(ByRef _ex As Exception)
        Try
            ...
            If _ex.StackTrace <> "" Then
                Dim st As StackTrace = New StackTrace(_ex, True)
                For Each sf As StackFrame In st.GetFrames

                    If sf.GetFileLineNumber > 0 OrElse sf.GetFileColumnNumber > 0 Then
                        Trace.WriteLine(String.Format("Trace line:{0}, column:{1}, file:{2}, method:{3}", sf.GetFileLineNumber, sf.GetFileColumnNumber, sf.GetFileName, sf.GetMethod.Name))
                    End If
